...
class TournamentManager:
    ...
    def swap_contestants(self, key1, key2):
        self.__contestants_in_the_normal_tree[key1], self.__contestants_in_the_normal_tree[key2] = self.__contestants_in_the_normal_tree[key2], self.__contestants_in_the_normal_tree[key1]
